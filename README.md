...
const DIFFICULTY_LEVELS = {
  easy: { size: 6, time: 10, name: 'Easy' },
  normal: { size: 8, time: 7, name: 'Normal' },
  hard: { size: 10, time: 5, name: 'Hard' },
  expert: { size: 12, time: 4, name: 'Expert' }
};
const TARGET_EMOJIS = ["🦊", "🐱", "🐶", "🐵", "🦄", "🐼", "🐸", "🐤", "🐙"];
...
// Achievement system
const ACHIEVEMENTS = [
  { id: 'first_win', name: 'First Hunt', description: 'Complete your first stage', icon: '🎯', threshold: 1 },
  { id: 'streak_5', name: 'Hunter', description: 'Reach 5 points', icon: '🏹', threshold: 5 },
  { id: 'streak_10', name: 'Master Hunter', description: 'Reach 10 points', icon: '👑', threshold: 10 },
  { id: 'speed_demon', name: 'Speed Demon', description: 'Find emoji in under 2 seconds', icon: '⚡', threshold: 1 },
